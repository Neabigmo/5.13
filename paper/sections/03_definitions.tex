...
\paragraph{Definition hygiene.}
The distinctions above are not bookkeeping trivia. Ordered duplicates,
conflicting labels, and deterministic tie-breaking are exactly the places where
local instability can hide. Several later examples collapse or become
