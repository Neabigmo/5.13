...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{outputs/figures/fig1_perturbation_semantics.pdf}
    \caption{Perturbation semantics.  LOO couples deletion to evaluation at the
    deleted occurrence, whereas replace-one decouples both the edited occurrence
    and the evaluation query.  This mismatch is the semantic source of the
    separation studied in the paper.}
    \label{fig:perturbation-semantics}
\end{figure}
