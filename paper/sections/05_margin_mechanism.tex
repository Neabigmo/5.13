...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.86\linewidth]{outputs/figures/fig2_margin_crossing.pdf}
    \caption{Replacement instability as a margin-crossing event.  The odd-$k$
    construction moves the signed margin from $-1$ to $+1$; the even-$k$
    construction moves it from the deterministic tie threshold $0$ to $+2$.}
    \label{fig:margin-crossing}
\end{figure}
