\section{Consistency Compatibility}
...
\cite{cover1967nearest,cover1968estimation,stone1977consistent}. Our results
operate on a different axis: fixed finite samples, deterministic tie-breaking,
and worst-case one-perturbation sensitivity.

\begin{figure}[t]
    \centering
    \includegraphics[width=0.84\linewidth]{outputs/figures/stability_regimes_map.pdf}
...
a distributional limit theorem. Both can be true simultaneously, and in the
current draft they are.
...
The practical lesson is simple. If one wants a stability notion for a local
...
prediction stability. The same phrase ``change one sample point'' cannot safely
do all four jobs at once.
