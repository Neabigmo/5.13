...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.82\linewidth]{outputs/figures/fig1_perturbation_semantics.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.82\linewidth]{outputs/figures/fig2_margin_crossing.pdf}
